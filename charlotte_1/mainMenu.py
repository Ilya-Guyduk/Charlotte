...
class OptionMenuHolder(ctk.CTkOptionMenu):
  ...
  def __init__(self, master):
    ...
    self.optionmenu_2 = ctk.CTkOptionMenu(self.frame_1,
                                                values=["Option 1", "Option 2", "Option 42 long long long..."],
                                                corner_radius=0,
                                                fg_color=("#696969"),
                                                button_color=("#778899"))
    ...
    self.optionmenu_3 = ctk.CTkOptionMenu(self.frame_1,
                                                values=["Option 1", "Option 2", "Option 42 long long long..."],
                                                corner_radius=0,
                                                fg_color=("#696969"),
                                                button_color=("#778899"))
    ...
    self.optionmenu_4 = ctk.CTkOptionMenu(self.frame_1,
                                                values=["Option 1", "Option 2", "Option 42 long long long..."],
                                                corner_radius=0,
                                                fg_color=("#696969"),
                                                button_color=("#778899"))
    ...
    self.optionmenu_5 = ctk.CTkOptionMenu(self.frame_1,
                                                values=["Option 1", "Option 2", "Option 42 long long long..."],
                                                corner_radius=0,
                                                fg_color=("#696969"),
                                                button_color=("#778899"))
    ...
    self.optionmenu_6 = ctk.CTkOptionMenu(self.frame_1,
                                                values=["Option 1", "Option 2", "Option 42 long long long..."],
                                                corner_radius=0,
                                                fg_color=("#696969"),
                                                button_color=("#778899"))
    ...
    self.optionmenu_7 = ctk.CTkOptionMenu(self.frame_1,
                                                values=["Option 1", "Option 2", "Option 42 long long long..."],
                                                corner_radius=0,
                                                fg_color=("#696969"),
                                                button_color=("#778899"))
