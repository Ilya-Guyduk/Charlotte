...
class RegWindow(ctk.CTkTabview):
  def __init__(self, master):
    ...
    self.login_password_entry = ctk.CTkEntry(self.regtabview.tab("Авторизация"),
    ...
    self.reg_entry = ctk.CTkEntry(self.regtabview.tab("Регистрация"),
    ...
    self.name_entry = ctk.CTkEntry(self.regtabview.tab("Регистрация"),
